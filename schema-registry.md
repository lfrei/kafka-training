...
💡 Inspect the schema that has been registered to the topic `avro-sensor`: http://myVMsIP:8080/ui/docker-kafka-server/schema or http://localhost:8080/ui/docker-kafka-server/schema
